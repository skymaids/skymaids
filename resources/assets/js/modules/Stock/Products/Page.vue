    ...
    <page :config="pageState">
        <div class="form" slot="content">
            <form method="post" class="form-horizontal form-app" @submit.prevent="filter" id="form-module-search">
                ...
                <div class="form-group row form-material row">
                    <label class="col-xs-12 col-md-3 form-control-label">Categoria:</label>
                    <div class="col-md-9 col-xs-12">
                        <select class="form-control" data-plugin="select2" multiple id="stock_category_id" name="stock_category_id" v-model="inputs.stock_category_id">
...
<script>
    ...
    import {MenuPage, StockCategory, Loader} from '../../../services/resources'
